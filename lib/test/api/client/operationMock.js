...
class OperationMock {
  constructor(destination) {
    ...
    this.spec           = getOperationSpec(serviceName, operationId)
...
const operationsSpecs    = {}

const setOperationsSpecs = specs => {
  for (let object of specs) {
    const { name, spec }  = object
    operationsSpecs[name] = {}
    ...
    for (let path in spec.paths) {
      ...
      for (let method in methods) {
        ...
        if (operationId) {
          operationsSpecs[name][operationId] = operation
        }
      }
    }
  }
...
const getOperationSpec = (serviceName, operationId) => {
  return _.get(operationsSpecs, `${serviceName}.${operationId}`)
}

exports = module.exports   = OperationMock
exports.setOperationsSpecs = setOperationsSpecs
exports.getOperationSpec   = getOperationSpec
